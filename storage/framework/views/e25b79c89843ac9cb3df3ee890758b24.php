...
<?php $__env->startSection('title', 'Penjagaan Harian'); ?>
...
<div class="space-y-6">
    <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4 bg-white p-5 rounded-2xl border border-slate-200 shadow-sm">
        ...
        <!-- Filter Form -->
        <form method="GET" action="<?php echo e(route('penerimaan.penjagaan.harian')); ?>" class="flex flex-wrap items-center gap-3">
            ...
            <?php if(request('fungsi') || request('jenis')): ?>
                <a href="<?php echo e(route('penerimaan.penjagaan.harian', ['bulan' => $bulan])); ?>" class="text-xs text-rose-500 hover:underline font-medium">Reset Filter</a>
            <?php endif; ?>
        </form>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mpnweb\resources\views/penerimaan/penjagaan/harian.blade.php ENDPATH**/ ?>