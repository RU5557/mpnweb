...
<!-- Nav Link Pencarian -->
<a href="<?php echo e(route('wp.search')); ?>" 
   class="flex items-center gap-3.5 px-3.5 py-2.5 rounded-xl text-[13px] font-semibold transition-colors <?php echo e(request()->routeIs('wp.search') ? 'bg-blue-600 text-white shadow-md shadow-blue-600/30' : 'hover:bg-slate-800 hover:text-white text-slate-300'); ?>">
                ...
                <div class="truncate text-[13px] md:text-sm">
                    <?php if(isset($rollingText) && $rollingText): ?>
                        <span class="text-slate-500">
                            Update: <?php echo e(\Carbon\Carbon::parse($rollingText->tanggal)->format('d-m-Y')); ?> |
                        </span> 
