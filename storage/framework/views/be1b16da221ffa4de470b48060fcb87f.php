...
<div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
    ...
    <!-- Filter Form -->
    <form action="<?php echo e(route('penerimaan.pkmpengawasan')); ?>" method="GET" class="bg-white border border-slate-200/80 rounded-2xl p-2.5 px-4 shadow-sm flex items-center gap-3">
        ...
        <?php if(request()->has('bulan') || request()->has('tahun') || request()->has('seksi') || request()->has('sort')): ?>
            <a href="<?php echo e(route('penerimaan.pkmpengawasan')); ?>" class="text-slate-400 hover:text-slate-600 text-base px-2 py-2 transition" title="Reset Filter">
            ...
            <tbody class="divide-y divide-slate-100 text-slate-700 font-medium">
                <?php $__empty_1 = true; $__currentLoopData = $pkmData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-slate-50/80 transition">
                        <td class="py-4 px-4 text-center text-slate-400 font-mono text-sm"><?php echo e($index + 1); ?></td>
