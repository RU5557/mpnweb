...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mt-6 text-center">
            <a href="<?php echo e(route('penerimaan.dashboard')); ?>" class="text-xs text-slate-500 hover:text-slate-800 font-medium">
...
</html><?php /**PATH C:\xampp\htdocs\mpnweb\resources\views/auth/login.blade.php ENDPATH**/ ?>