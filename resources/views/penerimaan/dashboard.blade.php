...
<div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
    ...
    <!-- Form Filter Compact -->
    <form action="{{ route('penerimaan.dashboard') }}" method="GET" class="bg-white border border-slate-200/80 rounded-2xl p-2.5 px-4 shadow-sm flex items-center gap-3">
        <select name="bulan" class="bg-slate-50 border border-slate-200 text-slate-700 text-sm rounded-xl px-3.5 py-2 font-bold focus:ring-2 focus:ring-blue-500 outline-none transition cursor-pointer">
        ...
        <select name="tahun" class="bg-slate-50 border border-slate-200 text-slate-700 text-sm rounded-xl px-3.5 py-2 font-bold focus:ring-2 focus:ring-blue-500 outline-none transition cursor-pointer">
